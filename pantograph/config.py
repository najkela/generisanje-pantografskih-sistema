...
class Config:
    ...
    # праг угла преноса ∠(a–u–b) сваког чвора кроз пуну ротацију (docs/NALAZ_01_09_ugao_prenosa.md).
    # Намерно ниско испод литературне препоруке за четворополужја (40°-140°) — оштар праг би
    # одбацио и здрава решења (12.6°, 14.1° синоћ); почетна вредност, калибрише се емпиријски (README 4.2).
    min_transmission_angle_deg: float = 5.0
